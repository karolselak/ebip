...
ItemTypeSchema = new SimpleSchema({
    ...
    inheritsFrom: {
        type: [String],
        label: 'array of types the type inherits from',
        defaultValue: []
    },
/*    'inheritsFrom.$.url': {
        type: String,
        label: 'urls defining type the type inherits from'
    },
    'inheritsFrom.$.properties': {
        type: [String],
        label: 'inherited properties defined as propertyTypes'
    },*/
    sameAs: {
        type: String,
 ...
 /*   propertiesInherited: {
    ...
    'propertiesInherited.$.name': {
        type: String,
        label:'property name'
    },
    'propertiesInherited.$.from': {
        type: String,
        label:''
    }*/
});
