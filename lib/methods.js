Meteor.methods({
    ...
    removeInstitutionFilter: function(ins_id, menuIndex, filterIndex) {
        var unset = {$unset: {}};
        unset.$unset['sideMenus.'+menuIndex+'.filters.'+filterIndex] = 1;
        Institutions.update({_id: ins_id}, unset)
        var pull = {$pull: {}};
        pull.$pull['sideMenus.'+menuIndex+'.filters'] = null;
        Institutions.update({_id: ins_id}, pull)
    }
});
