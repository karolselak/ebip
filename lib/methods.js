...
=======
        if (!(Meteor.user() && Meteor.user().GlobalRight)) {
            throw '# Adding item type failed - you have not global rights';
>>>>>>> real_custom_ui
        }
...
=======
        if (!(Meteor.user() && Meteor.user().GlobalRight)) {
            throw '# Adding property failed - you have not global rights';
        }
>>>>>>> real_custom_ui
...
=======
        if (!(Meteor.user() && Meteor.user().GlobalRight)) {
            throw '# Removing property failed - you have not global rights';
>>>>>>> real_custom_ui
        }
        var unset = {$unset: {}};
